...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { certame: @empresa.certame, cnpj: @empresa.cnpj, nome: @empresa.nome, objeto: @empresa.objeto, participante: @empresa.participante } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { certame: @empresa.certame, cnpj: @empresa.cnpj, nome: @empresa.nome, objeto: @empresa.objeto, participante: @empresa.participante } }
