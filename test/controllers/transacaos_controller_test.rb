...
class TransacaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transacao" do
    assert_difference('Transacao.count') do
      post transacaos_url, params: { transacao: { dataEmissao: @transacao.dataEmissao, dataPagamento: @transacao.dataPagamento, documento: @transacao.documento, empresa_id: @transacao.empresa_id, formaPagameto: @transacao.formaPagameto, justificativa: @transacao.justificativa, relacaoNegocio: @transacao.relacaoNegocio, valor: @transacao.valor } }
    end
  ...
  test "should update transacao" do
    patch transacao_url(@transacao), params: { transacao: { dataEmissao: @transacao.dataEmissao, dataPagamento: @transacao.dataPagamento, documento: @transacao.documento, empresa_id: @transacao.empresa_id, formaPagameto: @transacao.formaPagameto, justificativa: @transacao.justificativa, relacaoNegocio: @transacao.relacaoNegocio, valor: @transacao.valor } }
